        ...
        <div class="container page-top">
            <div class="tambahData">
                <div class="check">
                    ...
                    <br>
                    <form enctype="multipart/form-data" action="insertProsesMobil.php" method="POST">
                        <form method="GET" action="insertProsesMobil.php">
                            ...
                            <br>    
                            <p class="gmbr">Foto Mobil<input id="Foto" name="Foto" type="file" value="<?php echo $row['lokasi_foto'];?>"required></p>
                            <br>   
                            <tr>
